...
// ----------------------- Driver Vehicle Documents Verification------------------------------------//

exports.getVehicleVerificationStatus = async (req, res) => {
    try {
        ...
        // Send back current verification status
        return res.status(200).json({
            success: true,
            message: "Vehicle verification status fetched successfully",
            data: {
        ...
        return res.status(500).json({
            success: false,
            message: "Failed to fetch verification status. Try again.",
        });
    }
};